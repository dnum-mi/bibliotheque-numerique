      ...
      <div v-if="rnfClient.collisions.length" class="fr-pt-4w">
        <div class="fr-container">
          <div class="fr-grid-row">
            <div class="fr-col-3 cursor-pointer" @click="resetSelectedFoundation()">
              <h6 class="text-center">Demande d’inscription au RNF</h6>
              <p class="fr-text--bold">
                <span class="bullet fr-mr-2v fr-ml-n2v"><span class="fr-icon-bank-line" aria-hidden="true"></span></span
        ...
        <footer class="footer">
          ...
          <DsfrButton data-testid="create-btn" v-bind="buttonProps" @click="onclick" />
        </footer>
      </div>
    </div>
  </div>
