...
describe("InstructionTimesService", () => {
  ...
  it.each`
    ...
    ${"In instruction with receip of 1st Demand"}       | ${DossierState.EnInstruction}         | ${faker.date.past().toISOString()}  | ${faker.date.past(1, "2020-01-01")}                  | ${faker.date.future(1, "2020-01-01")}             | ${null}                                                            | ${null}                                           | ${null}                                                            | ${null}
    ${"In instruction with all dates"}                  | ${DossierState.EnInstruction}         | ${faker.date.past(1, "2020-01-01")} | ${faker.date.past(1, "2020-01-01")}                  | ${faker.date.between("2020-01-01", "2020-02-01")} | ${faker.date.between("2020-02-01", "2020-03-01")}                  | ${faker.date.between("2020-03-01", "2020-04-01")} | ${fakerDateOrNull(faker.date.between("2020-04-01", "2020-05-01"))} | ${null}
    ${"In instruction without the dates of 1st Demand"} | ${DossierState.EnInstruction}         | ${faker.date.past(1, "2020-01-01")} | ${null}                                              | ${null}                                           | ${faker.date.between("2020-01-01", "2020-02-01")}                  | ${faker.date.between("2020-02-01", "2020-03-01")} | ${fakerDateOrNull(faker.date.between("2020-03-01", "2020-04-01"))} | ${null}
    ${"In instruction with the date extension only"}    | ${DossierState.EnInstruction}         | ${faker.date.past(1, "2020-01-01")} | ${null}                                              | ${null}                                           | ${faker.date.future(1, "2020-02-01")}                              | ${null}                                           | ${null}                                                            | ${null}
    ${"In instruction with the date intent opppositon"} | ${DossierState.EnInstruction}         | ${faker.date.past(1, "2020-01-01")} | ${null}                                              | ${null}                                           | ${fakerDateOrNull(faker.date.between("2020-02-01", "2020-03-01"))} | ${null}                                           | ${null}                                                            | ${faker.date.future(1, "2020-03-01")}
