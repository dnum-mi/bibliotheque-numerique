...
describe("InstructionTimesService", () => {
  ...
  it.each`
    ...
    ${"In instruction with all dates"}                  | ${DossierState.EnInstruction}         | ${faker.date.past(1, "2020-01-01")} | ${faker.date.past(1, "2020-01-01")}                  | ${fakerDateOrNull(faker.date.future(1, "2020-01-01"))} | ${faker.date.between("2020-02-01", "2020-03-01")} | ${fakerDateOrNull(faker.date.between("2020-03-01", "2020-04-01"))} | ${faker.date.between("2020-01-01", "2020-02-01")}                  | ${null}
    ${"In instruction without the dates of 1st Demand"} | ${DossierState.EnInstruction}         | ${faker.date.past(1, "2020-01-01")} | ${null}                                              | ${null}                                                | ${faker.date.between("2020-02-01", "2020-03-01")} | ${fakerDateOrNull(faker.date.between("2020-03-01", "2020-04-01"))} | ${faker.date.between("2020-01-01", "2020-02-01")}                  | ${null}
  ...
  it.each`
    ...
    ${"In instruction, prorogation after 2nd demand"}                   | ${DossierState.EnInstruction}         | ${faker.date.past(1, "2020-01-01")}                 | ${null}                                                | ${null}                             | ${faker.date.between("2020-02-01", "2020-03-01")}      | ${fakerDateOrNull(faker.date.future(1, "2020-03-01"))} | ${fakerDateOrNull(faker.date.future(1, "2020-03-02"))} | ${null}
