...
const config = (): TInstructionTimeMappingConfig => ({
  instructionTimeMappingConfig: {
    ...
    [keyInstructionTime.DATE_REQUEST2]: 'Date de deuxième demande de pièces complémentaires',
    [keyInstructionTime.DATE_RECEIPT2]: 'Date de réception des pièces de la deuxième demande',
    [keyInstructionTime.DATE_INTENT_OPPOSITION]: "Date de l'intention d'opposition aux financements",
  },
