...
export class AddOrganismesDatasTable1672764637216 implements MigrationInterface {
  ...
  public async down (queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.dropForeignKey('organismes_datas', foreignKeyOrganismesSourceId)
