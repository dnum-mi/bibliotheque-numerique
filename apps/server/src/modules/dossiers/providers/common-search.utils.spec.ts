  ...
  describe('Text filters', () => {
    describe('Normal text filters', () => {
      ...
      it('Should build filter for "blank"', () => {
        ...
        ).toEqual('WHERE (("I09" IS NULL OR item = ""))')
      })
      ...
      it('Should build filter for "notBlank"', () => {
        ...
        ).toEqual('WHERE (("I09" IS NOT NULL OR item != ""))')
      })
    })
    describe('Array text filters', () => {
      ...
      it('Should build filter for "blank"', () => {
        expect(
          ...
          'WHERE ((EXISTS (SELECT 1 FROM UNNEST("I09") AS item WHERE item IS NULL OR item = "")))',
        )
      })
      ...
      it('Should build filter for "notBlank"', () => {
        expect(
          ...
          'WHERE ((EXISTS (SELECT 1 FROM UNNEST("I09") AS item WHERE item IS NOT NULL OR item != "")))',
        )
      })
    })
  })
  ...
  describe('Date filters', () => {
    describe('Normal date filters', () => {
      it('Should build filter for date equals condition', () => {
        ...
        ).toEqual('WHERE (("dateField" = \'2023-01-01\'))')
      })
    ...
    describe('Array date filters', () => {
      it('Should build filter for date equals condition', () => {
        expect(
          ...
          'WHERE ((EXISTS (SELECT 1 FROM UNNEST("dateField") AS item WHERE item = \'2023-01-01\')))',
        )
      })
    ...
    describe('Array number filters', () => {
      it('Should build filter for number equals condition', () => {
        expect(
          ...
          'WHERE ((EXISTS (SELECT 1 FROM UNNEST("numberField") AS item WHERE item = 10)))',
        )
      })
      ...
      it('Should build filter for number lessThan condition', () => {
        expect(
          ...
          'WHERE ((EXISTS (SELECT 1 FROM UNNEST("numberField") AS item WHERE item < 5)))',
        )
      })
      ...
      it('Should build filter for number greaterThan condition', () => {
        expect(
          ...
          'WHERE ((EXISTS (SELECT 1 FROM UNNEST("numberField") AS item WHERE item > 7)))',
        )
      })
      ...
      it('Should build filter for number greaterThanOrEqual condition', () => {
        expect(
          ...
          'WHERE ((EXISTS (SELECT 1 FROM UNNEST("numberField") AS item WHERE item >= 8)))',
        )
      })
    })
  })
