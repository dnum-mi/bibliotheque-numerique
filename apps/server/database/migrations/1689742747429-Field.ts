...
export class Field1689742747429 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."fields_formatfunctionref_enum" AS ENUM('country', 'status')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "fields" DROP CONSTRAINT "FK_5879469316854c7351c2b43f4ee"`,
    );
    await queryRunner.query(
      `ALTER TABLE "fields" DROP CONSTRAINT "FK_20c47f9bda3d993c7ae838c1566"`,
    );
