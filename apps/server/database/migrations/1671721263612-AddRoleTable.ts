...
export class AddRoleTable1671721263612 implements MigrationInterface {
  ...
  public async up (queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createUniqueConstraint('roles', new TableUnique({ name: 'UK_ROLE_NAME', columnNames: ['name'] }))

    await queryRunner.createPrimaryKey('users_roles', ['rolesId', 'usersId'], 'PK_USERS_ROLES_ID')
