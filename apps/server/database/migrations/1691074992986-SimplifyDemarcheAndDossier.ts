...
/*
  ...
  From now on, migration:generate should not generate anymore migration code that is not a direct consequence from changing entities.
  Developer should not generate migration manually so error can be avoided.
 */
export class SimplifyDemarcheAndDossier1691074992986
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "demarches" DROP CONSTRAINT "FK_DEMARCHE_DS_ID"`,
    );
    await queryRunner.query(
      `ALTER TABLE "dossiers" DROP CONSTRAINT "FK_DOSSIER_DS_ID"`,
    );
    await queryRunner.query(`DROP TABLE "dossiers_ds" CASCADE`);
    await queryRunner.query(`DROP TABLE "demarches_ds" CASCADE`);

    await queryRunner.query(
      `ALTER TABLE "organismes_datas" DROP CONSTRAINT "FK_ORGANISME_SOURCE_ID"`,
    );
    await queryRunner.query(
      `ALTER TABLE "organismes_datas" DROP CONSTRAINT "FK_ORGANISMES_DATAS_ORGANISMES"`,
    );
    await queryRunner.query(
      `ALTER TABLE "dossiers" DROP CONSTRAINT "FK_DEMARCHE_ID"`,
    );
    await queryRunner.query(
      `ALTER TABLE "instruction_times" DROP CONSTRAINT "FK_DOSSIER_ID"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users_roles" DROP CONSTRAINT "FK_USER_ID"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users_roles" DROP CONSTRAINT "FK_ROLE_ID"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "fields" DROP CONSTRAINT "UQ_30409f91c45a64aa504a0bd288f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "demarches" DROP CONSTRAINT "UQ_26cf3f8ffd8cb4ab69662ae7e34"`,
    );
    await queryRunner.query(
      `ALTER TABLE "demarches" DROP COLUMN "idDemarcheDS"`,
    );
    await queryRunner.query(
      `ALTER TABLE "demarches" DROP COLUMN "typeOrganisme"`,
    );
    await queryRunner.query(
      `ALTER TABLE "dossiers" DROP CONSTRAINT "UQ_86e38f82e5123a2e0180b643eda"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "demarches" ADD "dsDataJson" jsonb NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "dossiers" ADD "sourceId" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "dossiers" ADD "dsDataJson" jsonb NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "connectors" ALTER COLUMN "params" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "connectors" ALTER COLUMN "query" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "connectors" ALTER COLUMN "typeAuth" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "connectors" ALTER COLUMN "token" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "job_logs" DROP CONSTRAINT "UQ_58193ed7a13b6627e99dc1c0985"`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."job_logs_jobname_enum" RENAME TO "job_logs_jobname_enum_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."job_logs_jobname_enum" AS ENUM('no job name given.', 'ds-data-fetching', 'update-organisme')`,
    );
    await queryRunner.query(
      `ALTER TABLE "job_logs" ALTER COLUMN "jobName" DROP DEFAULT`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "job_logs" ALTER COLUMN "jobName" SET DEFAULT 'no job name given.'`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "organismes_datas" ALTER COLUMN "organismesSourceId" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "demarches" ALTER COLUMN "state" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "demarches" DROP COLUMN "identification"`,
    );
    await queryRunner.query(
      `ALTER TABLE "demarches" ADD "identification" character varying`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "dossiers" ALTER COLUMN "demarcheId" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "instruction_times" ALTER COLUMN "state" SET DEFAULT ''`,
    );
    await queryRunner.query(
      `ALTER TABLE "instruction_times" ALTER COLUMN "dossierId" DROP NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "dossiers" ADD CONSTRAINT "UQ_DOSSIER" UNIQUE ("sourceId", "demarcheId")`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "instruction_times" DROP CONSTRAINT "FK_9155053675d980c27f8160a4415"`,
    );
    await queryRunner.query(
      `ALTER TABLE "dossiers" DROP CONSTRAINT "FK_b26c655e0a94b6feae787042649"`,
    );
    await queryRunner.query(
      `ALTER TABLE "organismes_datas" DROP CONSTRAINT "FK_6f50cb4f6b633236c334435a607"`,
    );
    await queryRunner.query(
      `ALTER TABLE "organismes_datas" DROP CONSTRAINT "FK_23dec9cd0c803348e748be8923c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "dossiers" DROP CONSTRAINT "UQ_DOSSIER"`,
    );
    await queryRunner.query(`ALTER TABLE "fields" DROP CONSTRAINT "UQ_FIELD"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_deeb1fe94ce2d111a6695a2880"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_21db462422f1f97519a29041da"`,
    );
    await queryRunner.query(
      `ALTER TABLE "instruction_times" DROP CONSTRAINT "UQ_9155053675d980c27f8160a4415"`,
    );
    await queryRunner.query(
      `ALTER TABLE "instruction_times" ALTER COLUMN "dossierId" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "instruction_times" ALTER COLUMN "state" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "dossiers" ALTER COLUMN "demarcheId" DROP NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."fields_type_enum_old" RENAME TO "fields_type_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "demarches" DROP COLUMN "identification"`,
    );
    await queryRunner.query(
      `ALTER TABLE "demarches" ADD "identification" text`,
    );
    await queryRunner.query(
      `ALTER TABLE "demarches" ALTER COLUMN "state" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "organismes_datas" ALTER COLUMN "organismesSourceId" SET NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."job_logs_jobname_enum_old" RENAME TO "job_logs_jobname_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "job_logs" ADD CONSTRAINT "UQ_58193ed7a13b6627e99dc1c0985" UNIQUE ("id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "connectors" ALTER COLUMN "token" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "connectors" ALTER COLUMN "typeAuth" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "connectors" ALTER COLUMN "query" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "connectors" ALTER COLUMN "params" DROP NOT NULL`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "demarches" DROP COLUMN "lastSynchronisedAt"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users_roles" ADD "createAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "demarches" ADD "idDemarcheDS" integer`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_USERS_ROLES_ROLES" ON "users_roles" ("rolesId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_USERS_ROLES_USERS" ON "users_roles" ("usersId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_ORGANISME_TITLE" ON "organismes" ("title") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_ORGANISME_IDREF" ON "organismes" ("idRef") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_ORGANISME_DATA_IDREF" ON "organismes_datas" ("idRef") `,
    );
    await queryRunner.query(
