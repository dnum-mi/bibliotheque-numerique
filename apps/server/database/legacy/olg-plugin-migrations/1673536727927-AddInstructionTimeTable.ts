...
export class AddInstructionTimeTable1673536727927 implements MigrationInterface {
  ...
  public async down (queryRunner: QueryRunner): Promise<void> {
    ...
    const foreignKeyDossierId = table.foreignKeys.find((fk) => fk.columnNames.indexOf('dossierId') !== -1)
