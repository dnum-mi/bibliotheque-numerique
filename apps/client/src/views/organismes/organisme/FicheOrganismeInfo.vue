...
const dueDate = computed(() => props.organisme?.dueDate ? new Intl.DateTimeFormat('fr-FR').format(new Date(props.organisme?.dueDate)) : 'Illimitée')
...
const fiscalEndDateAt = computed(() => {
  return props.organisme?.fiscalEndDateAt && new Intl.DateTimeFormat('fr-FR', {
    day: '2-digit',
    month: '2-digit',
...
<template>
  <div class="flex gap-2">
    ...
    <div v-if="mapCenter && mapCenter.length" class="flex-basis-[30%]  flex-shrink-0  flex-grow-0  relative">
