...
* ([#1715](https://github.com/dnum-mi/bibliotheque-numerique/issues/1715)) récupérer les pièces joints en provenance de différent source ([#1800](https://github.com/dnum-mi/bibliotheque-numerique/issues/1800)) ([8e47617](https://github.com/dnum-mi/bibliotheque-numerique/commit/8e476178f5210e5a756826aab2aa658a1fa34b01))
* ✨ [#1530](https://github.com/dnum-mi/bibliotheque-numerique/issues/1530) ajoute une carte dans fiche info organisme ([ac58da8](https://github.com/dnum-mi/bibliotheque-numerique/commit/ac58da812e6515017eb175da678e4136fd872375))
* **1491:** add SSO on BN ([b714dcd](https://github.com/dnum-mi/bibliotheque-numerique/commit/b714dcd5104f0f5a13fc7ad27e3b059125065572))
* add ApiProperty for get foundation by idRnf ([31ab9ed](https://github.com/dnum-mi/bibliotheque-numerique/commit/31ab9ed94fa3f4baa1048abe552a9c3964892a6d))
* add config get url siaf-rnf ([9ccd41e](https://github.com/dnum-mi/bibliotheque-numerique/commit/9ccd41ed84ca015629e3921d90da23ef00bb0710))
* add configuration anonymization ([101a8a5](https://github.com/dnum-mi/bibliotheque-numerique/commit/101a8a572419bcb69b1b262c9bbff537201c64ea))
* add date formatting to long string fr format ([75cdb67](https://github.com/dnum-mi/bibliotheque-numerique/commit/75cdb6725463b38f2cfc137b0a6e1121249ccff9))
* add DossierChamps component like slot into DossierSection ([e03d993](https://github.com/dnum-mi/bibliotheque-numerique/commit/e03d993b0a1931438ff7be7f9ea894c807d98a40))
* add DossierSection and DossierSidemenu components with grouped champs functionality ([c251b17](https://github.com/dnum-mi/bibliotheque-numerique/commit/c251b179345b407a0d6273305d145f3b66dbab11))
* add double authentification on admin ([#1685](https://github.com/dnum-mi/bibliotheque-numerique/issues/1685)) ([74ae8d2](https://github.com/dnum-mi/bibliotheque-numerique/commit/74ae8d21b4055961d9393dfc90e24533d0f8cdee))
* add feature flag ([84eb25e](https://github.com/dnum-mi/bibliotheque-numerique/commit/84eb25efff2ac0e89d5ec81a7e2f6cd787c08946))
* add functions and mappers to create, to update and dissolve FRUP ([1f3cfbb](https://github.com/dnum-mi/bibliotheque-numerique/commit/1f3cfbbb0dc3240599722ebe94824fc9e43f3528))
* add in controller the trigger to update and to dissolve FRUP ([6cd511b](https://github.com/dnum-mi/bibliotheque-numerique/commit/6cd511b8ae04ba0f8e8c72265c699f0725923c37))
* add jwt authentification ([5105a64](https://github.com/dnum-mi/bibliotheque-numerique/commit/5105a64b4aa4218912ac66ff6aea397bb75061ad))
* add mapping anonymized in demarche and api for patch and get ([8a60384](https://github.com/dnum-mi/bibliotheque-numerique/commit/8a60384368fff20e7e8acffefc85ec3288efe34b))
* add mingration, schema, entity for FRUP into db rnf ([6e62cba](https://github.com/dnum-mi/bibliotheque-numerique/commit/6e62cba12326b055a740411a2677bd91a63a8db0))
* add organisme history ([#1834](https://github.com/dnum-mi/bibliotheque-numerique/issues/1834)) ([5fe919f](https://github.com/dnum-mi/bibliotheque-numerique/commit/5fe919f0aa1b9fbd2373d644295068095e09e4fb))
* add persons in migration and entity organisme ([05d314d](https://github.com/dnum-mi/bibliotheque-numerique/commit/05d314d45e7c445400db04c02f5a007ceddf1695))
* add prority job for sync organisme rnf ([69bdf35](https://github.com/dnum-mi/bibliotheque-numerique/commit/69bdf35b33b6eb84a017600d1759e3d9873e1e91))
* add refresh the synchronisation of one organisme in front ([04e1495](https://github.com/dnum-mi/bibliotheque-numerique/commit/04e149528fb4694c88fc46f9dbe663b84dddd5be))
* add send mail on failure after three login attempts ([#1692](https://github.com/dnum-mi/bibliotheque-numerique/issues/1692)) ([471f9a6](https://github.com/dnum-mi/bibliotheque-numerique/commit/471f9a6a1a19a91084132ed2162ac19fa202a02f))
* add spinner for fiche organisme ([a635bb3](https://github.com/dnum-mi/bibliotheque-numerique/commit/a635bb3792b035946c47e37aa4423079b8a7659c))
* add table of synchronization state ([47777f0](https://github.com/dnum-mi/bibliotheque-numerique/commit/47777f0c1e301fb42dc120b692120300950e60ab))
* add tour functionality with Shepherd.js integration and new BnTourStep component ([65bff28](https://github.com/dnum-mi/bibliotheque-numerique/commit/65bff281a335b51378001c53a2fd285bddb17d01))
* add tutorial steps for filter functionality and integrate help button in demarche page ([a3011fa](https://github.com/dnum-mi/bibliotheque-numerique/commit/a3011fa7529e69fe707f7e625b5666099546af57))
* add varaiable of foundation for sync hub ([ae0aa72](https://github.com/dnum-mi/bibliotheque-numerique/commit/ae0aa7202dc65d9c55af217d20f992deedd894f8))
* add variable configuration for synchronization with hub ([adf51ca](https://github.com/dnum-mi/bibliotheque-numerique/commit/adf51caf2413d8dee40c652da412b522c4a701bf))
* adding decleration years on organisme ([71a2766](https://github.com/dnum-mi/bibliotheque-numerique/commit/71a276621ad853cadee127a644ae545509ddbe07))
* adding test digit inside rnf for qualification ([5bdddd7](https://github.com/dnum-mi/bibliotheque-numerique/commit/5bdddd78604f913eb632fe2543e63889257b1536))
* anonymisation ([e2aa829](https://github.com/dnum-mi/bibliotheque-numerique/commit/e2aa829c32b7542805f2dcf1dacd57ca409d1f2f))
* **anonymization-champs:** entity and migration ([4877aac](https://github.com/dnum-mi/bibliotheque-numerique/commit/4877aac34673ff6f4fff798cdb251508b58b9b11))
* **anonymization-chmaps:** :wip: add new configuation event for anonymization ([fe7ea66](https://github.com/dnum-mi/bibliotheque-numerique/commit/fe7ea662dac68346a203cfb878f9214e828dee79))
* **bn:** add new qualities director ([b632ff7](https://github.com/dnum-mi/bibliotheque-numerique/commit/b632ff7f67dea94caef7e98338167ed7c2d031d1))
* build image by sequential ([17fb123](https://github.com/dnum-mi/bibliotheque-numerique/commit/17fb12386d8134920ed5aef2ecd12deeecdc44cc))
* config variable ENABLE_SIAF to ENABLE_SEARCH_HUB ([4d3ae32](https://github.com/dnum-mi/bibliotheque-numerique/commit/4d3ae321c0325305902eb507b2ef91fa91776f10))
* configuration env for SIAF ([5eefeea](https://github.com/dnum-mi/bibliotheque-numerique/commit/5eefeea8d3657e8c399559cd4375ceb591152c90))
* configuration for rnf-siaf ([8165374](https://github.com/dnum-mi/bibliotheque-numerique/commit/81653741424b8d5ee6b0fe2964309fbe0651d460))
* correction of authentification email and support url  ([579bb36](https://github.com/dnum-mi/bibliotheque-numerique/commit/579bb367c037e258162752b165c3993c6ead1f37))
* date creation inside DNR demarche ([a14875b](https://github.com/dnum-mi/bibliotheque-numerique/commit/a14875b23f6a64f15c8c01885abb5cf176211914))
* del elk ([fa24dba](https://github.com/dnum-mi/bibliotheque-numerique/commit/fa24dbadb4c6d801b3158ace5b09d08edcb2e814))
* delete refresh token expiered ([26f9a83](https://github.com/dnum-mi/bibliotheque-numerique/commit/26f9a831b6d22a6798eed15a515a5769347a603c))
* disable build rnf image in gitlab ci ([1e4e6ef](https://github.com/dnum-mi/bibliotheque-numerique/commit/1e4e6ef90f590eea378a129efed225b5b0b9f5ae))
* display persons of organisme ([9c59a70](https://github.com/dnum-mi/bibliotheque-numerique/commit/9c59a70e117882c65a22a7ac2871c617c06dd33b))
* enable by default sso ([13509bb](https://github.com/dnum-mi/bibliotheque-numerique/commit/13509bbf1ece5ab7a64c4005a6e30a3bfb2dd711))
* enhance shepherd footer styles and button interactions ([c19c6a4](https://github.com/dnum-mi/bibliotheque-numerique/commit/c19c6a4126a40905ebc5a0668b54c782d45c0258))
* enhance useTour functionality with improved error handling and cleanup processes ([0695673](https://github.com/dnum-mi/bibliotheque-numerique/commit/069567337b24e621cca6e1623afbc6ee00b3ba60))
* expose status of synchronization RNF ([c2e8936](https://github.com/dnum-mi/bibliotheque-numerique/commit/c2e893674b193a2fac2e479b0032acd5d9df2a0b))
* **FicheOrganisme:** ✨ [#1530](https://github.com/dnum-mi/bibliotheque-numerique/issues/1530) ajout autres infos dans fiche info ([fe487eb](https://github.com/dnum-mi/bibliotheque-numerique/commit/fe487eb4ec4724be0429cdbad0d272c17fcc6136))
* filter number accepte blank and notBlank ([28a527f](https://github.com/dnum-mi/bibliotheque-numerique/commit/28a527f1fa26e386f14d5133447445580dbc6934))
* fix linter ([f77f82d](https://github.com/dnum-mi/bibliotheque-numerique/commit/f77f82d418959272938be181439bfa50f8bff28d))
* fix pnpm-lock ([b659f3b](https://github.com/dnum-mi/bibliotheque-numerique/commit/b659f3b8c0054ae7f198deb37e0bb3dd9ccf1946))
* get motivation attachment from ds ([864c400](https://github.com/dnum-mi/bibliotheque-numerique/commit/864c4000bfb5dace9a73d9bc2492d720b37c0437))
* get organisme from hub ([1bdb1dc](https://github.com/dnum-mi/bibliotheque-numerique/commit/1bdb1dc33ae8c453d65c62c9d3fb50189c370949))
* icon and message for incorrect address ([2f076b6](https://github.com/dnum-mi/bibliotheque-numerique/commit/2f076b62a15767818fe15aeb80ee6f60e1973e1e))
* implement grouped champs functionality in Dossier components and improve layout styles ([61c50e7](https://github.com/dnum-mi/bibliotheque-numerique/commit/61c50e7a5dcf97459a4cc088709976b3715ca883))
* import users by excel file ([d12df05](https://github.com/dnum-mi/bibliotheque-numerique/commit/d12df05a61950a4da1ba788ea6e6bc0a8c2371fd))
* importing an existing user update its role. ([25601b1](https://github.com/dnum-mi/bibliotheque-numerique/commit/25601b167687082e629bcbd5dd3b3dff25c2bcca))
* improve wording ([d1ef6d1](https://github.com/dnum-mi/bibliotheque-numerique/commit/d1ef6d1a0a8da5abb78b86c908c79cca437bc380))
* interface Organisme Person ([c60d848](https://github.com/dnum-mi/bibliotheque-numerique/commit/c60d848110fa5ac5f0cbbc28c6291942ffffa3a7))
* interfaces model from rnf-siaf ([250dfd6](https://github.com/dnum-mi/bibliotheque-numerique/commit/250dfd6d2b506f2e0d83418a40019c30a8345af5))
* job and service for anonymisation the champs and annotations in dossier ([12e9a5d](https://github.com/dnum-mi/bibliotheque-numerique/commit/12e9a5d08b12ea484fab7576478b11db83021958))
* mapper get code from annotations (date creation FRUP) ([bcd1f6c](https://github.com/dnum-mi/bibliotheque-numerique/commit/bcd1f6c68a6ee6b9e490a6acd325198cf0a0b1b5))
* Mettre en visibilité les filtres actifs dans les listes (Organismes, Démarches, Administrations) ([#1791](https://github.com/dnum-mi/bibliotheque-numerique/issues/1791)) ([6204b6c](https://github.com/dnum-mi/bibliotheque-numerique/commit/6204b6c41bf9473a41f5deccc6bc0a56b2dbdd5e))
* migration for anonymisation ([31e56c0](https://github.com/dnum-mi/bibliotheque-numerique/commit/31e56c0cfdef8d03442a3b0daf5c71914d8ef91a))
* no display fix-field and champs deleted in mappngColumn for anonymization ([d04683f](https://github.com/dnum-mi/bibliotheque-numerique/commit/d04683f40cdb23eefd275b3ba590cd815018ff3f))
* Prefecture inside user - Harmonising prefecture in app ([751252c](https://github.com/dnum-mi/bibliotheque-numerique/commit/751252cf7a77dcf99a1ca9bf0bfaee48be3a6bfb))
* refactor tour step creation and update filter tutorial steps ([b35c6d2](https://github.com/dnum-mi/bibliotheque-numerique/commit/b35c6d22a41d4eaf7f60eca9a0c4fd1276d22e77))
* remove eslint warning, eslint ignore and add confirmation modal ([74d0fa2](https://github.com/dnum-mi/bibliotheque-numerique/commit/74d0fa2bee96622b6da50fee1dc9e064808bdd21))
* remove eslint warning, eslint ignore and add confirmation modal ([74d0fa2](https://github.com/dnum-mi/bibliotheque-numerique/commit/74d0fa2bee96622b6da50fee1dc9e064808bdd21))
* remove first letter from prefecture ([38558b2](https://github.com/dnum-mi/bibliotheque-numerique/commit/38558b29b3b0558fcc006a14677ec8cf7a49ec5f))
* reorganize display component and help button ([de7643d](https://github.com/dnum-mi/bibliotheque-numerique/commit/de7643d2446321eed5f9c85bc303dc13787b4d52))
* reposition help button to improve user accessibility for the tutorial ([9a07720](https://github.com/dnum-mi/bibliotheque-numerique/commit/9a077204a8a93ec3b76db7ec066c58584d1cc1ea))
* reverse menu order, set defaut page to organisme list ([6e49ae2](https://github.com/dnum-mi/bibliotheque-numerique/commit/6e49ae27681658923806eb4d423fff227433a5dd))
* rnf api http-proxy for switch staging or prod ([0309cc5](https://github.com/dnum-mi/bibliotheque-numerique/commit/0309cc58b5f265f53bb0290ecd83a4cec3880069))
* rnf, add isfounder in person of foudation ([6ba7204](https://github.com/dnum-mi/bibliotheque-numerique/commit/6ba720443f788ebee8d909fa71d9e740f7e3f53d))
* rnf, add new demarche administration changes for fdd and fe ([78e7e04](https://github.com/dnum-mi/bibliotheque-numerique/commit/78e7e04aa9983e1c093feb48f5785e646519553d))
* rnf, change person by demarche administration changes ([4eb37aa](https://github.com/dnum-mi/bibliotheque-numerique/commit/4eb37aa107e6df68961da36072be388453d5aaef))
* rnf, update ds-api-client for debug get dossier with champDescriptor ([bd562f3](https://github.com/dnum-mi/bibliotheque-numerique/commit/bd562f3768b29c2492c723cffd4b8eb7c500f684))
* rnf, update person foudation with new role ([8fabb83](https://github.com/dnum-mi/bibliotheque-numerique/commit/8fabb835a62ae82f534138676cd73bf9efc264ce))
* **rnf:** add creation date of foundation for all demarche of creation ([ed2b3ff](https://github.com/dnum-mi/bibliotheque-numerique/commit/ed2b3ffda00cd56b1b88310bba940ec664a4f404))
* **rnf:** add new qualities director ([8190fb5](https://github.com/dnum-mi/bibliotheque-numerique/commit/8190fb57456a538b4e5b57e06975ddc72349402b))
* **rnf:** del rnf ([5744031](https://github.com/dnum-mi/bibliotheque-numerique/commit/574403148531dfcbd3ef9c38c369f271346ea7e9))
* **rnf:** get department from department champs ([dd3c8d8](https://github.com/dnum-mi/bibliotheque-numerique/commit/dd3c8d86f9b2e42154ad4bd7ba0873ba0ff98dd1))
* **rnf:** save incorrect address ([f959a2e](https://github.com/dnum-mi/bibliotheque-numerique/commit/f959a2e3c95638e9960d0b7569d48a9c9b40c174))
* save display on localStorage ([7610316](https://github.com/dnum-mi/bibliotheque-numerique/commit/7610316b2ca369aa189af98ae6e8e5a132b212fb))
* search in register of association and foundation ([a121e1c](https://github.com/dnum-mi/bibliotheque-numerique/commit/a121e1c42cf69e84e61a7bb1054c8b63b7dadf7a))
* set dateTraiment when synchronisation ([6611aa1](https://github.com/dnum-mi/bibliotheque-numerique/commit/6611aa1679f2eb283ed19d4b4b40c0059564aebc))
* set synchrionization status for rnf ([fd1e5cd](https://github.com/dnum-mi/bibliotheque-numerique/commit/fd1e5cd63ca9b15637cf4a55d6a855aec168a137))
* shared interface anonymization ([54a17db](https://github.com/dnum-mi/bibliotheque-numerique/commit/54a17dbb7284e2b62533f7bfb03a58515557ef1c))
* Sync rna from hub ([#1864](https://github.com/dnum-mi/bibliotheque-numerique/issues/1864)) ([c342f57](https://github.com/dnum-mi/bibliotheque-numerique/commit/c342f573023f3687e81bf22cb731308b33e8ed85))
* synchronize foundation files with hub ([297abe5](https://github.com/dnum-mi/bibliotheque-numerique/commit/297abe5bbb4001acf7a034fc066377060c1bfb67))
* synchronize foundation with hub ([0ae3c86](https://github.com/dnum-mi/bibliotheque-numerique/commit/0ae3c86db5748ac3d97a57931b0192a77dd10f38))
* synchronize selected fondation from search hub ([f23ee01](https://github.com/dnum-mi/bibliotheque-numerique/commit/f23ee01921885132d90b8966da77ec3e94323453))
* unicity of synchronising dossier and organisme ([f3fbe9a](https://github.com/dnum-mi/bibliotheque-numerique/commit/f3fbe9a7730d1bbf7ded388eb1c9bc93172e7f26))
* update association of format RAF in server ([5d4d9f9](https://github.com/dnum-mi/bibliotheque-numerique/commit/5d4d9f9ac6667a13e05456ed362c284cd21b1165))
* update config and improvements on sso ([2eaa011](https://github.com/dnum-mi/bibliotheque-numerique/commit/2eaa011c6c1a003959732d39c070040646349664))
* update design for smaller screen ([18efd5d](https://github.com/dnum-mi/bibliotheque-numerique/commit/18efd5ddddbe25f7d99ecc77ef9b0507fa017d50))
* update Dossier views for improved layout and type handling ([d1cf492](https://github.com/dnum-mi/bibliotheque-numerique/commit/d1cf492c38f1bd847945cda615677c630d098668))
* update entity for model siaf-rnf ([469535f](https://github.com/dnum-mi/bibliotheque-numerique/commit/469535ffdfc8387e981be26a5e72f7635da2eb97))
* update fiche organisme for  hub - code refactoring ([8b3bfea](https://github.com/dnum-mi/bibliotheque-numerique/commit/8b3bfeaba8401973c854ed35c8a3768bb6f988ff))
* update for redeployer ([ab7489a](https://github.com/dnum-mi/bibliotheque-numerique/commit/ab7489a654ce02c6e9eeddff9b7879857a9370b4))
* update interface to insert association of RAF ([896a679](https://github.com/dnum-mi/bibliotheque-numerique/commit/896a679dcc55b2f26152a5abcc7802ca1df5deca))
* update proconnect button ([cba87b1](https://github.com/dnum-mi/bibliotheque-numerique/commit/cba87b154d35029a7bfb662b38cef2750f92cb48))
* update syncho rnf to synchro rnf-siaf ([6816c69](https://github.com/dnum-mi/bibliotheque-numerique/commit/6816c69c6f015b15d8f2ef06f2c1a5bd20b98c0b))
* upgrade the page of manage role of users ([06a2b9e](https://github.com/dnum-mi/bibliotheque-numerique/commit/06a2b9ed85bbb5192a9c1e27013511cd0a78e425))
* use dockerhub for build image ([7d9f4d0](https://github.com/dnum-mi/bibliotheque-numerique/commit/7d9f4d063a6a608dfd73a5c82cf2b066498c2b12))


### Bug Fixes

* ([#1781](https://github.com/dnum-mi/bibliotheque-numerique/issues/1781)) Replace DsfrTabe by one component Tabs  ([226ed89](https://github.com/dnum-mi/bibliotheque-numerique/commit/226ed89942b3ad16f90ce84b3de6e26a87e010e7))
* [#1538](https://github.com/dnum-mi/bibliotheque-numerique/issues/1538) - service instructeur no show in list dossiers ([106f81a](https://github.com/dnum-mi/bibliotheque-numerique/commit/106f81aa9fd64b33f8753fbc7a7436fa57ae525e))
* [#1542](https://github.com/dnum-mi/bibliotheque-numerique/issues/1542): update description title and logo MI ([3b1d321](https://github.com/dnum-mi/bibliotheque-numerique/commit/3b1d321fa020c27abe03e46c89c4aa1049fa9c39))
* **#1865:** selected children of mappingColumns gone after sync demarche ([88edb50](https://github.com/dnum-mi/bibliotheque-numerique/commit/88edb50d8c28a2bf6ad6bf0a82fd4c7acdeaa0aa))
* add ds and hub check in health ([2d392f7](https://github.com/dnum-mi/bibliotheque-numerique/commit/2d392f7339c85e6f95be2597df49fa39bd0c5da7))
* add endpoint /health/info and /health/liveliness ([07a7304](https://github.com/dnum-mi/bibliotheque-numerique/commit/07a7304e2b99ea7300348c3a99e78bec6c428a17))
* add filter enum for etat delai ([9b015fa](https://github.com/dnum-mi/bibliotheque-numerique/commit/9b015fa5cbc8e973576e87e24aa576deaa1ba064))
* add interface for entity SyncState ([c947c04](https://github.com/dnum-mi/bibliotheque-numerique/commit/c947c04f2eb469830135407289e57af968558a19))
* add isFondateur and refacto person interface in libShared ([0bdabf1](https://github.com/dnum-mi/bibliotheque-numerique/commit/0bdabf16e964214ab12ba876fa6f3a8612a2f183))
* add log in rnf-back ([1316705](https://github.com/dnum-mi/bibliotheque-numerique/commit/131670548dd59961561cdbfee8888cdf4f40dcb0))
* add module tsconfig for node 20 ([7792e6b](https://github.com/dnum-mi/bibliotheque-numerique/commit/7792e6bb5003e55b0db2178523c2a817b9144a1a))
* add new departments in shared ([b3dce99](https://github.com/dnum-mi/bibliotheque-numerique/commit/b3dce99dc6561e924f53bdb1bc4540ecfe736679))
* add new type benificiaire ([0c7bc1e](https://github.com/dnum-mi/bibliotheque-numerique/commit/0c7bc1e3d382f0903bc0fb48968926d696bcc10c))
* add one category of demarche in role of user ([8f093b8](https://github.com/dnum-mi/bibliotheque-numerique/commit/8f093b85939d810211d0df39557be7c47bb99897))
* add or remove all anonymized field in array ([9aef7ce](https://github.com/dnum-mi/bibliotheque-numerique/commit/9aef7ce81a83a62c15a55ba7cedfdd8d95a5f21d))
* add prefecture of user in the page of manage role ([40c977d](https://github.com/dnum-mi/bibliotheque-numerique/commit/40c977d5fa8a6189f25ae0cf6c1787d354549c02))
* add profession of person in fiche organisme ([2d20781](https://github.com/dnum-mi/bibliotheque-numerique/commit/2d207810be8f93e22add95016bddd9d5d6d2fd6a))
* add proxy for sso ([6831e71](https://github.com/dnum-mi/bibliotheque-numerique/commit/6831e718d7deab41fa67df45589552540cad3d66))
* add token for api SIAF ([32e7170](https://github.com/dnum-mi/bibliotheque-numerique/commit/32e717001e6c93f341719311e931461a2e589751))
* add type yes-no from DS ([abcf912](https://github.com/dnum-mi/bibliotheque-numerique/commit/abcf9122a6587223e29e0aa92fa11f6c364b1477))
* adress for associations ([55581c3](https://github.com/dnum-mi/bibliotheque-numerique/commit/55581c313da2c0907ebac12c55c3573b33676afe))
* all log true by default ([a554b9c](https://github.com/dnum-mi/bibliotheque-numerique/commit/a554b9c5f2853fbe33a3a36ef3acb1a797097445))
* already declared years ([42ca294](https://github.com/dnum-mi/bibliotheque-numerique/commit/42ca2948ac50889e55b8eeb1d966da2095c3cbed))
* **anonymization:** anonymize field of type repetitionChamp ([0408850](https://github.com/dnum-mi/bibliotheque-numerique/commit/0408850a44b441fe34c90b26b2bf1ecdb272b72d))
* **anonymization:** repetitionChamp use rows in new version or champs in old version ([ee35dd8](https://github.com/dnum-mi/bibliotheque-numerique/commit/ee35dd82564cf8cf878d930f0511484b2a2a7071))
* **anonymization:** test-e2e for fields without repetitionChamp ([b094972](https://github.com/dnum-mi/bibliotheque-numerique/commit/b094972a88a4a91ac8f2a1aba35abfe60c419b6e))
* autorize show tabs in demarche view ([ab03e1a](https://github.com/dnum-mi/bibliotheque-numerique/commit/ab03e1a2b3b2f2c33c694ef64555d51a05f39291))
* better design for organism file ([22504ed](https://github.com/dnum-mi/bibliotheque-numerique/commit/22504edd9fd0f47a828c7fffbf9cdf9e03831df8))
* **BN:** update fondation even if there are not field ([ee11862](https://github.com/dnum-mi/bibliotheque-numerique/commit/ee11862794bf1c3d061e7b3f7058351a77c12f4c))
* bug in the synchronizatiion of organisme ([a52a15c](https://github.com/dnum-mi/bibliotheque-numerique/commit/a52a15c6d18d5286a4a29f9a721c56cd7703532f))
* bug undefined in fiche organisme ([a0eb204](https://github.com/dnum-mi/bibliotheque-numerique/commit/a0eb204d4766bd02c582df21d2cb60b654b474d9))
* build container rnf-server ([bc6965c](https://github.com/dnum-mi/bibliotheque-numerique/commit/bc6965ce0396783fb09c040f635c1e6677db8ef4))
* build docker for packageManager missing in package.json ([aea722c](https://github.com/dnum-mi/bibliotheque-numerique/commit/aea722cc232166fdbac0c6be74c8438aaca92d33))
* can disable anonymisation for one demarche ([75437cc](https://github.com/dnum-mi/bibliotheque-numerique/commit/75437cc84acb0f4cd7b4c601bc5e4e831bfcb231))
* catch error by job for no stop others jobs ([43ea2e8](https://github.com/dnum-mi/bibliotheque-numerique/commit/43ea2e859d9222cda2ad9badc03929f044dd51b6))
* catching error rnf during crons ([6250be5](https://github.com/dnum-mi/bibliotheque-numerique/commit/6250be544ae7c524c95947c212d2b4503129a107))
* change REGISTRY_URL in ci dso ([e4e5ef0](https://github.com/dnum-mi/bibliotheque-numerique/commit/e4e5ef0dbc0359dbe9b64391fde3044f4797e7ca))
* change wording and remove default config ([f04a61d](https://github.com/dnum-mi/bibliotheque-numerique/commit/f04a61d04022df2397b33196e61bbb039d3f1d6d))
* changing password validate email too ([a040fc0](https://github.com/dnum-mi/bibliotheque-numerique/commit/a040fc013d1a6fa8abe95944febaff9c1f201248))
* clear cookies after status 401 ([aa84099](https://github.com/dnum-mi/bibliotheque-numerique/commit/aa840990c78d19850753ccf5e60a75f20201bf08))
* close filter modal after saving current filter ([9ee2391](https://github.com/dnum-mi/bibliotheque-numerique/commit/9ee2391eb40dbced3b782fa7e37dfbb4e290a27c))
* conflicts ([8b84812](https://github.com/dnum-mi/bibliotheque-numerique/commit/8b8481212658b2e991bc8fd091d51810b084e515))
* conflicts on vite.config.ts ([46e8d61](https://github.com/dnum-mi/bibliotheque-numerique/commit/46e8d61378521d6ceab08a3fa4144ff5cc7cb199))
* correct prefecture label inside list ([a1db443](https://github.com/dnum-mi/bibliotheque-numerique/commit/a1db4438583b3a01db0adbe4780ecbf98abe1aba))
* create fields instruction-time for dossiers without date instruction ([452f2c2](https://github.com/dnum-mi/bibliotheque-numerique/commit/452f2c2e5853a62a5284c0e8bf60f6afc361ccf9))
* create migration to update fields.stringValue index ([081bfc4](https://github.com/dnum-mi/bibliotheque-numerique/commit/081bfc482008016c503432c28bdb874d361422e3))
* create number rnf for dossier in instruction only ([44baa34](https://github.com/dnum-mi/bibliotheque-numerique/commit/44baa34f22f3f8105b4935b820e825f92491d412))
* cron job run by event ([1692113](https://github.com/dnum-mi/bibliotheque-numerique/commit/169211322d54a4cd54a22fe8c5003cc0289a47c6))
* customerFilters ([ade35f2](https://github.com/dnum-mi/bibliotheque-numerique/commit/ade35f24f1b3d5e5ab163d762a8861e186f8a428))
* cypresse error in dossier demande vue ([d674afd](https://github.com/dnum-mi/bibliotheque-numerique/commit/d674afd887ffe3237c0066c551ce70dc1dc4ea70))
* datas of anonymization can to be NULL ([96f4b90](https://github.com/dnum-mi/bibliotheque-numerique/commit/96f4b90a4bae7a49116f41c25ffd814bdd626db7))
* debug ci scaleway ([bcb6725](https://github.com/dnum-mi/bibliotheque-numerique/commit/bcb672511c6f975426227f0f7bbe91d8bbcf3cba))
* debug ci, add default conf for proconnect ([25a1b12](https://github.com/dnum-mi/bibliotheque-numerique/commit/25a1b1275b1588874f9311b0f7a2d58f58a08d5b))
* debug formatPrefecture and add log when run user-import ([4f0bd6e](https://github.com/dnum-mi/bibliotheque-numerique/commit/4f0bd6eacd3ec9ae958bf7f4ba1959f705cc9685))
* debug gitlab-ci-dso for DSO ([518dac1](https://github.com/dnum-mi/bibliotheque-numerique/commit/518dac116a0761badc9c5c7e7399a181469afa86))
* debug woker docker for start ([fb0dfb4](https://github.com/dnum-mi/bibliotheque-numerique/commit/fb0dfb47556b285ebdcb75f35c4f069dd569fa94))
* decrement remainin time ([#1771](https://github.com/dnum-mi/bibliotheque-numerique/issues/1771)) ([015a75d](https://github.com/dnum-mi/bibliotheque-numerique/commit/015a75d2c4b6df7d66f4120c5fd7eb4c1b039c18))
* del CI/CD for OVH staging ([656449f](https://github.com/dnum-mi/bibliotheque-numerique/commit/656449f0e639842cf94a799c72af285cea9e05c3))
* del copy link in organisme file ([e9b05d6](https://github.com/dnum-mi/bibliotheque-numerique/commit/e9b05d61ed769a25d83cd35de06d6528c87df99c))
* del rnf config ([d672961](https://github.com/dnum-mi/bibliotheque-numerique/commit/d672961e5353f5ac2d3079be403f57da2c26a150))
* delete anomymised file in S3 ([c4c9fae](https://github.com/dnum-mi/bibliotheque-numerique/commit/c4c9faeb82f57bab0acf0fc3ef554101fb3c18ba))
* delete cron job existing to update ([694211f](https://github.com/dnum-mi/bibliotheque-numerique/commit/694211f9768a98c331c4af623983e3eefdfc0097))
* delete existing job cron ([b5046dc](https://github.com/dnum-mi/bibliotheque-numerique/commit/b5046dcdb2b7979cf825fbaa0b1e6a9a7c3ba96f))
* delete organisme in FRONT ([afdad24](https://github.com/dnum-mi/bibliotheque-numerique/commit/afdad24f8f65e6a856cfdb39e2ca16959b106a46))
* delete organisme in server ([60225e8](https://github.com/dnum-mi/bibliotheque-numerique/commit/60225e8b2b9f04f336a43554776072200dfbeb06))
* delete/set repeatable jobs ([210d91b](https://github.com/dnum-mi/bibliotheque-numerique/commit/210d91b50283a4f665e50832635a0394e404eada))
* DepartementChamps from ds-api-client ([31735ab](https://github.com/dnum-mi/bibliotheque-numerique/commit/31735abcd640b49e7d545d2eaff79fd33219eda0))
* display collision even if there are not files ([24f5cf5](https://github.com/dnum-mi/bibliotheque-numerique/commit/24f5cf59567fe96dafeec111308175006f9e7868))
* display obsolete due to missing children ([0f73f6c](https://github.com/dnum-mi/bibliotheque-numerique/commit/0f73f6c12b348c37b2759d993bf82b40390b9f22))
* display prefecture of one organisme ([879fa4f](https://github.com/dnum-mi/bibliotheque-numerique/commit/879fa4f4c6e90adf151b562ec20005fd23234391))
* do not filter or sort column if unselected ([13102a6](https://github.com/dnum-mi/bibliotheque-numerique/commit/13102a691b9a75205e140c1c29f1d356b4b8f500))
* do not override sudo while importing ([bdb23e7](https://github.com/dnum-mi/bibliotheque-numerique/commit/bdb23e786865ac7db77be0238e6c50fda78111a0))
* do not send refresh token inside all request ([4712326](https://github.com/dnum-mi/bibliotheque-numerique/commit/47123267242a3d0de2e441722ccea44a08890984))
* dont reupload file from rna if it already exists ([84acd8c](https://github.com/dnum-mi/bibliotheque-numerique/commit/84acd8cdb2dded8b328962419c8c6dc5e9681af0))
* download file ([#1659](https://github.com/dnum-mi/bibliotheque-numerique/issues/1659)) ([be37553](https://github.com/dnum-mi/bibliotheque-numerique/commit/be375538434de032da5ffedca38e08a9eed104c1))
* download file ([#1659](https://github.com/dnum-mi/bibliotheque-numerique/issues/1659)) ([be37553](https://github.com/dnum-mi/bibliotheque-numerique/commit/be375538434de032da5ffedca38e08a9eed104c1))
* échec de suppression du filtre Exercices manquants de type CustomNumbersFilter ([8b85d89](https://github.com/dnum-mi/bibliotheque-numerique/commit/8b85d89dcbca1b5e1d65e31378569fb490f1e5f9))
* edge case when foundation has no fiscalendDate ([da2470a](https://github.com/dnum-mi/bibliotheque-numerique/commit/da2470a965188b2318a19ed76226c0179e53141a))
* enhance cell validation by trimming and case-insensitive matching against authorized list ([7a1fe2a](https://github.com/dnum-mi/bibliotheque-numerique/commit/7a1fe2a05dcf23fb4de90a25dced635accf63ae2))
* error to read properties from undefined ([db64a3c](https://github.com/dnum-mi/bibliotheque-numerique/commit/db64a3cc049db423b0f68a15e696a5bb4ca6d71a))
* espace between columns for persons in fiche organism ([6efda46](https://github.com/dnum-mi/bibliotheque-numerique/commit/6efda46646a6508a27daa108e683839f5eecd1f1))
* filter ag-grid for boolean ([52dbb82](https://github.com/dnum-mi/bibliotheque-numerique/commit/52dbb82a7e3d415ca8bfc244ce51400850b94c01))
* filter date saved for ag-grid ([5cf602c](https://github.com/dnum-mi/bibliotheque-numerique/commit/5cf602cec0ce4a7dd39fb8cfb79a85a23c6ecac8))
* filter with operator AND and OR ([a154d02](https://github.com/dnum-mi/bibliotheque-numerique/commit/a154d02fa77b68c6bb2761f1d5521db660625e15))
* filtering on type and missingDeclarationYears columns ([2651fcc](https://github.com/dnum-mi/bibliotheque-numerique/commit/2651fccd5519cdb963b55ed1a8e073fd316d6998))
* fix code from linter ([962ce51](https://github.com/dnum-mi/bibliotheque-numerique/commit/962ce51410840b09597a2bf81e4d31c0c2698cb6))
* fix: build docker for packageManager missing in package.json for rnf ([0dac127](https://github.com/dnum-mi/bibliotheque-numerique/commit/0dac127e70276c87c5bea3213a9737dff4f8145c))
* footer mini ([8b8fe04](https://github.com/dnum-mi/bibliotheque-numerique/commit/8b8fe04f850b25ba43763e3fa42282105fb7eb36))
* fr word for anonymise ([7ff4f66](https://github.com/dnum-mi/bibliotheque-numerique/commit/7ff4f665873bad346cac78eb8bf9581573a9f4a1))
* gestion des préfectures pour toutes les démarches ([#1802](https://github.com/dnum-mi/bibliotheque-numerique/issues/1802)) ([379a33c](https://github.com/dnum-mi/bibliotheque-numerique/commit/379a33cdb0847c9f06a392a15e9d7324b0cb3ffb))
* gestion error init Proconnect with proxy ([e25fffa](https://github.com/dnum-mi/bibliotheque-numerique/commit/e25fffad2e409dbe5267294b66cac2a8bfbf50c2))
* get date from dateChamp to dateValue of field ([6e57b6c](https://github.com/dnum-mi/bibliotheque-numerique/commit/6e57b6c3161531490f1064d00503d654a7da25e1))
* get env when start with turbo ([073b4ce](https://github.com/dnum-mi/bibliotheque-numerique/commit/073b4cebc3e1fef5d35cce20e1db2a52b07386a5))
* get organisme with person fron rnf ([f80a0a0](https://github.com/dnum-mi/bibliotheque-numerique/commit/f80a0a097686d4ba18b5b429ae25fe75b1dd37a1))
* init keys redis to synchro organisme by dossier ([95762db](https://github.com/dnum-mi/bibliotheque-numerique/commit/95762db5574bce9054573b8c63d7d598eecd49e5))
* instantly disconnect a user on 403 ([ed66dd7](https://github.com/dnum-mi/bibliotheque-numerique/commit/ed66dd771399b043beda4e527465d5d2a4198a94))
* interceptor jwt error ([024e533](https://github.com/dnum-mi/bibliotheque-numerique/commit/024e533d771988928e1be253901fb2efb3809475))
* job-id is useless and prevent re-sync ([fef91af](https://github.com/dnum-mi/bibliotheque-numerique/commit/fef91af1b56d468e53297c5f0a78a90d0548cedc))
* jwt env variables ([97c29e5](https://github.com/dnum-mi/bibliotheque-numerique/commit/97c29e513380a9b60e0db8667894db545e1f1cdb))
* linter ([60b805e](https://github.com/dnum-mi/bibliotheque-numerique/commit/60b805e759f0d562360e9b351340798cb663f95e))
* linter ([65f5d64](https://github.com/dnum-mi/bibliotheque-numerique/commit/65f5d64cc80d500c5e314633b24ee91b91a7c6a2))
* linter ([902ffc0](https://github.com/dnum-mi/bibliotheque-numerique/commit/902ffc0297759a32f5819c2ee06810f9853b260c))
* linter client ([b7b4d8b](https://github.com/dnum-mi/bibliotheque-numerique/commit/b7b4d8bd3284a62b79cd693adae3de4f229d067b))
* linter server ([0903655](https://github.com/dnum-mi/bibliotheque-numerique/commit/0903655fa1cf1f8f2f61962bc71a995692c19535))
* list benificiaires and creators ([27e43d4](https://github.com/dnum-mi/bibliotheque-numerique/commit/27e43d42241c5dce945d87214dff427c31f74f5e))
* make filter date work wether its a date or a datetime ([36b4510](https://github.com/dnum-mi/bibliotheque-numerique/commit/36b45107d3b48a3d1c695319e8f08b6d60112503))
* message for department missing ([5631bf5](https://github.com/dnum-mi/bibliotheque-numerique/commit/5631bf5d6e52a433bfd3606dee61c16f0d1dc998))
* message of already registered ([3252977](https://github.com/dnum-mi/bibliotheque-numerique/commit/3252977fee1b536cd3461cda120fd4f578776f66))
* migration db to remove ENABLE_RNF_SIAF ([9d79fd8](https://github.com/dnum-mi/bibliotheque-numerique/commit/9d79fd8d3ee6922765e51ee600437051b48ef8f2))
* migration enableRnfSiaf and enableSiaf ([7ba6401](https://github.com/dnum-mi/bibliotheque-numerique/commit/7ba64011adabcc920124e8bb2849427cbea16193))
* migration for yes-no champs for type dsChampType of field ([284f2ec](https://github.com/dnum-mi/bibliotheque-numerique/commit/284f2ecfeaba0c53ba98006a87b84fb3d61fc644))
* migration to add new departments ([3ca8816](https://github.com/dnum-mi/bibliotheque-numerique/commit/3ca8816b202decf7c7be32f01e8f661b0cddf49b))
* model of anonymization ([6fa0da2](https://github.com/dnum-mi/bibliotheque-numerique/commit/6fa0da21f4a3a241020c764b45f34beb1ab3d45b))
* move proconnect - front ([a61fbf1](https://github.com/dnum-mi/bibliotheque-numerique/commit/a61fbf135cd51793ef5c9c8581ac78e0a3b5dc44))
* naming on organism header ([fbf9874](https://github.com/dnum-mi/bibliotheque-numerique/commit/fbf9874d3203e14ab5868719c3035156a784eff2))
* new design front collison ([53d6c72](https://github.com/dnum-mi/bibliotheque-numerique/commit/53d6c72056995e1f9d4f0cc9cfddeabc76d2c047))
* new endpoint from  rnf-siaf ([11556f7](https://github.com/dnum-mi/bibliotheque-numerique/commit/11556f75ac2f84aef55cda099864472fb125fa8d))
* new wording regarding connection failure ([e0d3aa0](https://github.com/dnum-mi/bibliotheque-numerique/commit/e0d3aa02dd28bac7b3ac9f146f0af9b210ae3bc9))
* no limit when download organisme xlsx ([8945391](https://github.com/dnum-mi/bibliotheque-numerique/commit/89453918c6e01ee1f35852f9053f8384b13741e3))
* no more in-range for number filters ([e7897e0](https://github.com/dnum-mi/bibliotheque-numerique/commit/e7897e0d29ea325e28a6efaa414d0e0da9c780c9))
* not message from adress null in fiche organisme ([a640996](https://github.com/dnum-mi/bibliotheque-numerique/commit/a640996b5b30803416de827b35a3e2b9cd4c98e2))
* notEqual filter ([dc5f6cb](https://github.com/dnum-mi/bibliotheque-numerique/commit/dc5f6cb9dd6ba42583531227bb463d48343667dd))
* null value convert to empty string value for stringValue of Fields ([8c9de8c](https://github.com/dnum-mi/bibliotheque-numerique/commit/8c9de8cd37e000ac25ce35768a302bbbcf9d2d18))
* objet and "Caractère ..." are in 4 lines max otherwise display scroll bar ([4e7901f](https://github.com/dnum-mi/bibliotheque-numerique/commit/4e7901f67d49528fd53d64f311b8dc804bf35134))
* optimise code for anonymise ([31cb9c6](https://github.com/dnum-mi/bibliotheque-numerique/commit/31cb9c630298b2e4739fe6468f0d23f08f648032))
* order person role of organisme ([29607ac](https://github.com/dnum-mi/bibliotheque-numerique/commit/29607ac1d0e317f1a2d6262ff11cd6df802a7516))
* organism search ([97278da](https://github.com/dnum-mi/bibliotheque-numerique/commit/97278da4b49bd3d0b2f97d2986d7ad1c7b534fe2))
* organism search ([97278da](https://github.com/dnum-mi/bibliotheque-numerique/commit/97278da4b49bd3d0b2f97d2986d7ad1c7b534fe2))
* organism search ([c86dda3](https://github.com/dnum-mi/bibliotheque-numerique/commit/c86dda3e2625ff7a355535a6168020731a3bcac3))
* pnpm to v8.12.1 ([1059ff5](https://github.com/dnum-mi/bibliotheque-numerique/commit/1059ff5dc9180d4c366c34bc4367114abdc4cec5))
* prefecture name now works with both different hyphens (– OR -) ([f6ddc9b](https://github.com/dnum-mi/bibliotheque-numerique/commit/f6ddc9b7758cf3621836fc8f53ed3e3eb5da0275))
* pretty status in filter in statistics cards ([0bc1fd0](https://github.com/dnum-mi/bibliotheque-numerique/commit/0bc1fd09cec9bd525d7f0e7fc450de629c6fe9f4))
* preventing db crash on BIG INT ([ddb621b](https://github.com/dnum-mi/bibliotheque-numerique/commit/ddb621b644dcad2ba2d6952cf1e0a10eed7d44de))
* readd comment and create modal confirm component ([2ec9ae8](https://github.com/dnum-mi/bibliotheque-numerique/commit/2ec9ae82fa37039a176ee0b54fde549e1163cea0))
* refacto fiche association for hub v0.0.9 ([caf2b32](https://github.com/dnum-mi/bibliotheque-numerique/commit/caf2b3203c6321cf3d776ea8c3751551d1852dbb))
* refus d ajout d une préfecture en tant qu administrateur national([#1823](https://github.com/dnum-mi/bibliotheque-numerique/issues/1823))([#1842](https://github.com/dnum-mi/bibliotheque-numerique/issues/1842)) ([5547a20](https://github.com/dnum-mi/bibliotheque-numerique/commit/5547a20a2123c185d03ff8c9b2b6c0ad1b34bac3))
* remove button on dossier & improve navbar on small screen ([ea9ef5b](https://github.com/dnum-mi/bibliotheque-numerique/commit/ea9ef5b4f4ada35fece4a7eb64972dddf088eaa5))
* remove button to link TLD in front ([4fda6fd](https://github.com/dnum-mi/bibliotheque-numerique/commit/4fda6fd6cf51e105060544f2c2a274c4ace26a3e))
* remove comment useless ([21e9799](https://github.com/dnum-mi/bibliotheque-numerique/commit/21e979975d40b2bcb2ecf7b507de27c8a4b57740))
* remove duplicate client and useless test ([9ff1a0a](https://github.com/dnum-mi/bibliotheque-numerique/commit/9ff1a0a786326c984e7b8c909c3f495ecb830e11))
* remove fetch font of google by unocss ([8c36701](https://github.com/dnum-mi/bibliotheque-numerique/commit/8c36701363fab8d2c770112e2efeadcb2fa8bd39))
* remove proconnect svg ([74bf1d6](https://github.com/dnum-mi/bibliotheque-numerique/commit/74bf1d665fa48318fdab223138d2f07a4acedcb6))
* remove queue for organismes synchronization ([035c747](https://github.com/dnum-mi/bibliotheque-numerique/commit/035c74797d23fdec9a4ad1bbbb169a31da90dcca))
* remove search results raw data in front ([cd24bdc](https://github.com/dnum-mi/bibliotheque-numerique/commit/cd24bdc9f92231432b412cadc05e137e91b596c3))
* remove try catch of logout endpoint ([3fce37d](https://github.com/dnum-mi/bibliotheque-numerique/commit/3fce37da0ab4b3faab12a62f354f312abe8303f7))
* remove try catch of refresh endpoint ([cdeeee1](https://github.com/dnum-mi/bibliotheque-numerique/commit/cdeeee176b8e1360805020fd61b33a3107fa7adf))
* remove typescript exceptions ([78ccafd](https://github.com/dnum-mi/bibliotheque-numerique/commit/78ccafdfbe9254bf25d539f5511d029c10ff9153))
* remove unicity job for dossier ([600de0d](https://github.com/dnum-mi/bibliotheque-numerique/commit/600de0d8511e37ee3196efc101c7a5200f0556e1))
* remove useless async ([55f95a0](https://github.com/dnum-mi/bibliotheque-numerique/commit/55f95a0172ff195f0c23180db7ea5447f7bf0700))
* remove variable env useless ([5b98798](https://github.com/dnum-mi/bibliotheque-numerique/commit/5b98798d236aee6ceeb195af0029ce1b9a608f14))
* rename function get foundation from hub ([c2b4a66](https://github.com/dnum-mi/bibliotheque-numerique/commit/c2b4a66f28d6bd7f3e5dc9edea602a1877fba5fd))
* rename isFondateur to isfounder in BN ([f8dd099](https://github.com/dnum-mi/bibliotheque-numerique/commit/f8dd0996657e718bcd0e41ffc0f60260b5c79124))
* rename of types ([6500569](https://github.com/dnum-mi/bibliotheque-numerique/commit/6500569837ef923f8e5085983434047b9dab7e50))
* rename type MappingColunm ([6e66103](https://github.com/dnum-mi/bibliotheque-numerique/commit/6e66103141a516145cd3880853c78aae0ce0a587))
* rename variable env of siaf ([196a591](https://github.com/dnum-mi/bibliotheque-numerique/commit/196a5910cb09fb563e604bb075ad50b2b743537f))
* replace confirm by confirmModal ([0cfa5a7](https://github.com/dnum-mi/bibliotheque-numerique/commit/0cfa5a74d3cd73732ff45c34ec9966b4e790325e))
* replace ds url with new url ([443cce0](https://github.com/dnum-mi/bibliotheque-numerique/commit/443cce04e66cc25349a052c6c259342e0b8834df))
* replace FE_EXCEL_AMOUNT_CHAMP_ID by FE_AMOUNT_CHAMP_TAG in ds_configuration ([6651cb9](https://github.com/dnum-mi/bibliotheque-numerique/commit/6651cb980f9ab1766e97b709d470c5238fcacf8f))
* replace function of fakerJs deprecated ([621d8f5](https://github.com/dnum-mi/bibliotheque-numerique/commit/621d8f52079059a16088caf58741c4f135b7c1d5))
* replace npm xlsx ([#1657](https://github.com/dnum-mi/bibliotheque-numerique/issues/1657)) ([efe26dc](https://github.com/dnum-mi/bibliotheque-numerique/commit/efe26dc5439fa70a0f3090d106e4e78267c2f048))
* resize ag-grid ([f18e9c1](https://github.com/dnum-mi/bibliotheque-numerique/commit/f18e9c1bb8b67494ce7f5df5e7a7c1b55bf92e8b))
* rnf, del old person when update foudation ([984b256](https://github.com/dnum-mi/bibliotheque-numerique/commit/984b25688362cc84f0225e2630757679b6bb77ab))
* rnf, regroup foundation change method in service ([84c3415](https://github.com/dnum-mi/bibliotheque-numerique/commit/84c3415035d5ae17ec5e97734ee506846f90e544))
* rnf: person field should not be mandatory ([7d64cf7](https://github.com/dnum-mi/bibliotheque-numerique/commit/7d64cf7004954c1b1f14e8e9f5964a118cafcd42))
* **rnf:** debug release-please and clean rnf in docs ([1e7911c](https://github.com/dnum-mi/bibliotheque-numerique/commit/1e7911c643ab9983af3f1a30a07da9ad60b9e555))
* run dev:client in project root ([0b44c6d](https://github.com/dnum-mi/bibliotheque-numerique/commit/0b44c6de6037d2257a04f8a76184c1c2654fc2c1))
* run turbo in pod of kube ([baa28ab](https://github.com/dnum-mi/bibliotheque-numerique/commit/baa28ab9cede20769f5e7e04b00e7436425b83fc))
* select filter ([c8f53e1](https://github.com/dnum-mi/bibliotheque-numerique/commit/c8f53e16997074a2aee0d0756ac7ec7c6753e629))
* select filter ([#1750](https://github.com/dnum-mi/bibliotheque-numerique/issues/1750)) ([c8f53e1](https://github.com/dnum-mi/bibliotheque-numerique/commit/c8f53e16997074a2aee0d0756ac7ec7c6753e629))
* selected configuration of demarche ([605468e](https://github.com/dnum-mi/bibliotheque-numerique/commit/605468ef099e72b5ddc73a5ac1b4d27d5e742e98))
* set characters length of fields.stringValue index to 400 ([82aa9c5](https://github.com/dnum-mi/bibliotheque-numerique/commit/82aa9c551dc08bab171495ffb29103f1965d1a32))
* set DS_API_HEALTH default false ([a9a3078](https://github.com/dnum-mi/bibliotheque-numerique/commit/a9a3078226b63269531e0e36a5003eb6633639e9))
* set filter into ag-grid from server ([59ebf0f](https://github.com/dnum-mi/bibliotheque-numerique/commit/59ebf0ffe0cf3c827cb88d5354e56f2afc1aac6b))
* set new endpoint password ([4ad372e](https://github.com/dnum-mi/bibliotheque-numerique/commit/4ad372e69372151a51cee742fbe8e61c32f83c18))
* set text for blanks of ag grid filtre ([70d33cc](https://github.com/dnum-mi/bibliotheque-numerique/commit/70d33ccda3c447a10f72a9c1b33c454089a96728))
* show dossier when prefecture is null ([12ad55e](https://github.com/dnum-mi/bibliotheque-numerique/commit/12ad55e2cf9eb127d10a29ce9c47d33aa913e8ea))
* show fiche organisme fron fiche dossier ([b800581](https://github.com/dnum-mi/bibliotheque-numerique/commit/b80058187800f38793e8d349e73621ddb830e57e))
* show footer on all pages ([6e49e10](https://github.com/dnum-mi/bibliotheque-numerique/commit/6e49e10888445f5a1819bafa2dda7dcb22aa8fb7))
* show message of dossier in tabContent ([f2b560d](https://github.com/dnum-mi/bibliotheque-numerique/commit/f2b560d34adc6890abb4df43093a877860c7325d))
* show PJ in page Fiche organisme ([0287290](https://github.com/dnum-mi/bibliotheque-numerique/commit/02872900f48bc969755ac6203f8b7ccd7b3aeee2))
* show pj in the page dossier ([#1774](https://github.com/dnum-mi/bibliotheque-numerique/issues/1774)) ([ab0e82f](https://github.com/dnum-mi/bibliotheque-numerique/commit/ab0e82f75fb120eaeff3ede60d50a3b2eb818075))
* show tab raf only for foundation ([e29d204](https://github.com/dnum-mi/bibliotheque-numerique/commit/e29d2048e327e6265357f33a1f5fc19f71a58a2c))
* split error messages of inputs  on front RNF ([5dafe5f](https://github.com/dnum-mi/bibliotheque-numerique/commit/5dafe5f86abb6ed14c0547b5506efcf0928e372e))
* standardization text in code ([72ff7d4](https://github.com/dnum-mi/bibliotheque-numerique/commit/72ff7d4c666c418b5fa61ffdaf0c3d4a1e973866))
* standardization text in code 2 ([dacd530](https://github.com/dnum-mi/bibliotheque-numerique/commit/dacd5308a6ec3a5f84783852bdbd05db49a067b6))
* synchronization rna by ask admin-tech ([33f2855](https://github.com/dnum-mi/bibliotheque-numerique/commit/33f2855aef3b77cf9bf9ae1cff815de32393767f))
* syntax error on missingDeclarationYears column name inside hash ([2852b2e](https://github.com/dnum-mi/bibliotheque-numerique/commit/2852b2e0c8e0decfdb4cb3c334d036bc1bb7243d))
* test components ([d808328](https://github.com/dnum-mi/bibliotheque-numerique/commit/d808328bd8bf66858db688e3b76056a9266e8a0e))
* test e2e for anonymise ([8353b58](https://github.com/dnum-mi/bibliotheque-numerique/commit/8353b581b365afc8353f273f1a6727bd01d50eb5))
* test-e2e anonymization ([a1d32af](https://github.com/dnum-mi/bibliotheque-numerique/commit/a1d32af99963e9e3c0a12f7cd071fe27214c3244))
* test-e2e for frup ([e3c2b92](https://github.com/dnum-mi/bibliotheque-numerique/commit/e3c2b92722c44346a0fed2320fd5353516f31d03))
* the message null has no properties ([5de044d](https://github.com/dnum-mi/bibliotheque-numerique/commit/5de044db74876177532e6c180f1c607491538bd5))
* transaction for error entity field building from DS ([17200a0](https://github.com/dnum-mi/bibliotheque-numerique/commit/17200a0ac7d298f9af68bef65067e0c659dbbdf0))
* transition tabs in list dossiers ([4c84449](https://github.com/dnum-mi/bibliotheque-numerique/commit/4c8444903167c783619b3ada9d31a7f5e31549d4))
* type formatFunctionRef in fonction sync excel ([4189a76](https://github.com/dnum-mi/bibliotheque-numerique/commit/4189a7652cf2e92b99657a94789c71d104282d3b))
* typescript ([d3f5fd0](https://github.com/dnum-mi/bibliotheque-numerique/commit/d3f5fd0be9ecbddc4765abc4fea8d9d4db17261d))
* typescript any in sendMail ([6ab963d](https://github.com/dnum-mi/bibliotheque-numerique/commit/6ab963d18d132e937c436ac1d609b26de6f1e646))
* typescript interface ([d5aa65e](https://github.com/dnum-mi/bibliotheque-numerique/commit/d5aa65e1d4ecdb53e5469de908ff6f14ac65f65e))
* typo on typescript ([393e52e](https://github.com/dnum-mi/bibliotheque-numerique/commit/393e52e708c7726e0eb7a766fc07de20e5701742))
* typo, renaming error ([45e88aa](https://github.com/dnum-mi/bibliotheque-numerique/commit/45e88aa99cd64158cb94f568604434792b37c700))
* until organism is sync, front cannot click on it ([5fe3ad0](https://github.com/dnum-mi/bibliotheque-numerique/commit/5fe3ad02a69bc019f7995dbf76cf471d95dff16c))
* update auto-imports ([4cc852e](https://github.com/dnum-mi/bibliotheque-numerique/commit/4cc852eeffd9016c5e2c2fd676d94bc466727ce6))
* update code department of Corse ([40a50a7](https://github.com/dnum-mi/bibliotheque-numerique/commit/40a50a781eb008f78d857b1501b2a4ebdd728f19))
* update dependency Vue-dsfr v8 ([#1647](https://github.com/dnum-mi/bibliotheque-numerique/issues/1647)) ([f07ada1](https://github.com/dnum-mi/bibliotheque-numerique/commit/f07ada17c19bb1ebadae0fccc78999822a93f02d))
* update ds-api-client ([cbd4771](https://github.com/dnum-mi/bibliotheque-numerique/commit/cbd47719ee8e3525dacee2813a4d2553598ad419))
* update gitignore for pnpm store ([7f06a79](https://github.com/dnum-mi/bibliotheque-numerique/commit/7f06a7953481d8a691a373e250fcf49ea25c0e11))
* update heigth of list organisme ([a3c715f](https://github.com/dnum-mi/bibliotheque-numerique/commit/a3c715fda877747b8ca28318c7872fbcc3b06f3c))
* update interface for foundation ([1550b72](https://github.com/dnum-mi/bibliotheque-numerique/commit/1550b72dbe193cdb0b7de60819856c72fcd0a168))
* update list of columns of dossiers in after modified configuration ([ad5553f](https://github.com/dnum-mi/bibliotheque-numerique/commit/ad5553f6fac85504010fada7cd7176706e5a44b3))
* update max characters on index fields.stringValue ([2e5f28c](https://github.com/dnum-mi/bibliotheque-numerique/commit/2e5f28c62f32e0f993521439d213080b1babe076))
* update nestjs/swagger in rnf ([dcfe965](https://github.com/dnum-mi/bibliotheque-numerique/commit/dcfe965a5913c8f5b119507e507bc76875adb35e))
* update openid-client version for proconnect, and gestion error for client ([94b62f2](https://github.com/dnum-mi/bibliotheque-numerique/commit/94b62f28e7c579c8df822169b83a4d243167c9a5))
* update query of pagination to get dossiers when filter enum is select no value ([904b40c](https://github.com/dnum-mi/bibliotheque-numerique/commit/904b40ca64cb5d4fb4083197e4a6210dd2f1a1cb))
* update sso discovery url ([62b2ffd](https://github.com/dnum-mi/bibliotheque-numerique/commit/62b2ffdaf1ee1e6f40609dee48e8569b69268c7c))
* update the types of organisme ([5f70715](https://github.com/dnum-mi/bibliotheque-numerique/commit/5f70715521d82ab1f692706eabc7a74e58a584a0))
* update title of tabs without unregistry ([2b94208](https://github.com/dnum-mi/bibliotheque-numerique/commit/2b942080e9b7bfd20c7554da6fd5bf01c5f63f6c))
* update vue-dsfr ([dc4fc4c](https://github.com/dnum-mi/bibliotheque-numerique/commit/dc4fc4caa50c95e94340daf89611d352c7bb8a29))
* upload first file from ds ([ee6b6c0](https://github.com/dnum-mi/bibliotheque-numerique/commit/ee6b6c0c294c4060892297cd3d8594eeed2b3be7))
* use algoritm json for open-id connect ([cc76173](https://github.com/dnum-mi/bibliotheque-numerique/commit/cc76173ef55976d7e02e8bb9bc18ad8e38114052))
* use DsfrModal ([f0f7d45](https://github.com/dnum-mi/bibliotheque-numerique/commit/f0f7d45f881e83a3fcc8f9ec6eacab02f2b5e802))
* use main for env dev ([53b8998](https://github.com/dnum-mi/bibliotheque-numerique/commit/53b899835dedef9554444b0355ba6b244bcccaaa))
* use main with default branch ([160676e](https://github.com/dnum-mi/bibliotheque-numerique/commit/160676e3e5adc6ba2997a77959d49e2c846d2f1c))
* use same color DS for dossier state ([3882e9c](https://github.com/dnum-mi/bibliotheque-numerique/commit/3882e9c2acde73b1b2406fe95aabb0be0f671865))
* use same dsfr icon in menu and each page ([cef8a49](https://github.com/dnum-mi/bibliotheque-numerique/commit/cef8a4919babd4b3f2746be6ebf179f98eca44e1))
* user-import check email is unique in excel data ([c49744c](https://github.com/dnum-mi/bibliotheque-numerique/commit/c49744c54e4107daebec2d97a99592fd5585c9d4))
* variables name in env-exemple ([5211d4a](https://github.com/dnum-mi/bibliotheque-numerique/commit/5211d4a78466554a291e60148a293a791c4ae9cb))
* wording ([111c2f4](https://github.com/dnum-mi/bibliotheque-numerique/commit/111c2f4b81d225e3c4a3bcce820883aa082b9af9))
* wording ([d0b6ca1](https://github.com/dnum-mi/bibliotheque-numerique/commit/d0b6ca143e4eac78bd330643d65cd663d81c93ad))
* wording - list of organismes ([506598b](https://github.com/dnum-mi/bibliotheque-numerique/commit/506598b9f25fc7cc851332d064c224751436d9ad))
* wording - Status ([96d9f52](https://github.com/dnum-mi/bibliotheque-numerique/commit/96d9f52211044806b0e4de7ccf400becb97e3927))
* wording - syncchronization ([6772430](https://github.com/dnum-mi/bibliotheque-numerique/commit/6772430665c2fcbfa4551402c9d6baa1084e2271))
* wording for data missing ([42e3a8f](https://github.com/dnum-mi/bibliotheque-numerique/commit/42e3a8f4abcd3c44c44dbee1260787cc4e3f157b))
* wording in fiche organisme ([75f88df](https://github.com/dnum-mi/bibliotheque-numerique/commit/75f88dfef95c6e81234fbac444b776528d3c9633))
* wording in fiche organisme ([ee038e0](https://github.com/dnum-mi/bibliotheque-numerique/commit/ee038e0f55bdd9035f1ea6b0f85d82f5575fe3b0))
* wording no role in profile page ([0a84c49](https://github.com/dnum-mi/bibliotheque-numerique/commit/0a84c49523a90667a47b370dd2287fe510a911c2))
* wording prefecture in fiche organisme ([43844ba](https://github.com/dnum-mi/bibliotheque-numerique/commit/43844baa5c40256f63889bcd32c31f2ac6c97d88))
* wording prefecture to service instructeur ([3b3250a](https://github.com/dnum-mi/bibliotheque-numerique/commit/3b3250af20f564934868f7dbeb2fb57628f5e54a))
* wording service instructor in list dossier of fiche organisme ([fe0e141](https://github.com/dnum-mi/bibliotheque-numerique/commit/fe0e1419afff1940055619fe1024100c46b74107))
* write annotation private by demarcheId ([0e4bc62](https://github.com/dnum-mi/bibliotheque-numerique/commit/0e4bc62cb7e1ed1c7c2295f20e7ed370fe7e2655))
